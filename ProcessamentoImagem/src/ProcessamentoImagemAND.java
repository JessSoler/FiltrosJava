...
public class ProcessamentoImagemAND {
    ...
    public static void main(String[] args) {
        try {
            ...
            BufferedImage resultadoAnd = aplicarAND(imagem1, imagem2);
            exibirImagem(resultadoAnd, "Resultado Operação AND");
        } catch (IOException e) {
            e.printStackTrace();
        }
    }

    private static BufferedImage aplicarAND(BufferedImage img1, BufferedImage img2) {
