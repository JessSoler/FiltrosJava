...
public class ProcessamentoImagemOR {
    public static void main(String[] args) {
        try {
            ...
            BufferedImage resultadoOr = aplicarOR(imagem1, imagem2);
            exibirImagem(resultadoOr, "Resultado Operação OR");
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
    private static BufferedImage aplicarOR(BufferedImage img1, BufferedImage img2) {
